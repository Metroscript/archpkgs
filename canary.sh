...
sudo pacman -Syu --needed linux-{headers,lts{,-headers}} wayland mesa pipewire{,-{jack,pulse,alsa}} wireplumber gwenview plasma-{wayland-session,nm,desktop,pa,firewall,disks,thunderbolt,vault,systemmonitor} k{gamma5,infocenter,screen,screenlocker,menuedit,wayland-integration,eepassxc,pipewire,de{plasma-addons,-gtk-config}} powerdevil gimp discover sddm{,-kcm} nemo{,-fileroller,-share} gparted qbittorrent rhythmbox lollypop x{ed,reader,fce4-terminal} spectacle libreoffice-still gnome-calculator mpv print-manager simple-scan vulkan-{radeon,icd-loader} wine{,-gecko} gnutls lutris vkd3d lib{pulse,mythes,va-mesa-driver,32-{gnutls,lib{pulse,va-mesa-driver},vkd3d,pipewire{,-jack},mesa,vulkan-{radeon,icd-loader}}} steam flatpak xdg-desktop-portal-kde phonon-qt5-gstreamer gnu-free-fonts vim{,-spell-en} ttf-{hack-nerd,ubuntu-font-family} rust hunspell{,-en_au} mythes-en yt-dlp cups{,-pdf} gutenprint foomatic-db-{engine,ppds,gutenprint-ppds} atomicparsley virtualbox{,-host-dkms} firewalld neofetch
