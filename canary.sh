...
sudo pacman -Syu --needed linux-{headers,lts{,-headers}} wayland mesa pipewire{,-{jack,pulse,alsa}} wireplumber plasma-{wayland-session,nm,desktop,pa,firewall,disks,thunderbolt,vault,systemmonitor} k{gamma5,infocenter,screen,screenlocker,menuedit,wayland-integration,eepassxc,pipewire,de{plasma-addons,-gtk-config}} powerdevil discover sddm{,-kcm} nemo{,-fileroller,-share} g{wenview,imp,parted,nome-calculator} qbittorrent rhythmbox lollypop x{ed,reader,fce4-terminal,dg-desktop-portal-kde} spectacle libreoffice-still mpv print-manager simple-scan vulkan-{radeon,icd-loader} wine{,-gecko} gnutls lutris vkd3d lib{pulse,mythes,va-mesa-driver,32-{gnutls,lib{pulse,va-mesa-driver},vkd3d,pipewire{,-jack},mesa,vulkan-{radeon,icd-loader}}} steam flatpak{,-kcm} phonon-qt5-gstreamer gnu-free-fonts wl-clipboard vim-spell-en ttf-{hack-nerd,ubuntu-font-family} rust hunspell{,-en_au} mythes-en yt-dlp cups{,-pdf} gutenprint foomatic-db-{engine,ppds,gutenprint-ppds} atomicparsley virtualbox{,-host-dkms} firewalld neofetch
